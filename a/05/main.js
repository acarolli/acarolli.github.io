document.addEventListener("DOMContentLoaded", function() {
  // Aqui está o seu código JavaScript que gera o HTML
  var conteudoDiv = document.getElementById("conteudo");
  conteudoDiv.innerHTML = `<div class="top-text" id="topdiv">Carregando Informações</div>
    ...
    <a-entity id="visible-object" gltf-model="./assets/treasure/scene.gltf" animation-mixer gps-new-entity-place="latitude: -19.987079; longitude: -43.963870" scale="0.01 0.01 0.01" visible="false"></a-entity>
